...
# Propiedades del objeto `laiiqatoolbox`
   ...
   \item{ `xf` : Establece un valor final de tiempo, $x_f$ para cada linea de datos, de acuerdo a las unidades establecidas en  `xlabel`. **Opciones**: `'end'` (default) | <`x>` (cualquier valor de tiempo). Ejemplo: `miobjeto.xf = { 60 'end' 45 ...etc }`. Con `xlabel = 'min'`, `60` y `45` corresponden a minutos. }
