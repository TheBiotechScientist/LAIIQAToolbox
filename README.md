...
# Propiedades del objeto `laiiqatoolbox`
   ...
   - `xf` : Establece el valor de *x* final para cada linea de datos. Ociones: `'end'` para restaurar a todos los valores | cualquier valor positivo de tiempo. Ejemplo: `miobjeto.xf = { 28 'end' 45 ...etc }`.
